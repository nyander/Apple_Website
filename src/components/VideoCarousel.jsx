        ...
        <>
            <div className='flex items-center'>
                ...
                {hightlightsSlides.map((list,i) => (
                    <div key={list.id} id='slider' className='pr-18 sm:pr-20'>
                        <div className='video-carousel_container'>
                            <div className='flex-center size-full overflow-hidden rounded-3xl bg-black'>
                                ...
                                preload='auto' 
                                muted 
                                className={` ${list.id === 2 && 'translate-x-44'} pointer-events`}
            ...
            <div className='flex-center relative mt-10'>
                <div className='flex-center rounded-full bg-gray-300 px-7 py-5 backdrop-blur'>
                    {videoRef.current.map((_, i) => (
                        <span key={i}
                        ref={ (el) => (videoDivRef.current[i] = el)} className='relative mx-2 size-3 cursor-pointer rounded-full bg-gray-200'>
